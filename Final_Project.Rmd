...
Looking at a similar plot with rent and population data and the relationship with the eviction variables. Once again, nothing really jumps out at us that is not already to be expected. There is a strong positive relationship between evictions and population and renter occupied households, this is to be expected. We would expect this to be true, places with more people will have more evictions. The other variables relationship with Eviction Rate are all very weak and we do not feel confident about a causal relationship.
...
Looking at the counties with the highest percentage of African Americans in Minnesota compared to the counties with the highest eviction rates show that there is not that much overlap in Minnesota. Hennepin County (the county with the highest percentage of African Americans) has a very average rate of eviction compared to the other counties in Minnesota. Hennepin County does have the highest number of evictions in the state and while the rate may be low, there is a gap in the data. We do not know if African American renters are evicted at higher rates because we do not have eviction data by race. So while the rate in the county with the highest number of evictions is low, it could be disproportionately African Americans who are evicted.
